...
SELECT p.ID,
  ...
  ROUND(AVG(DEFENSIVE_SAFETIES), 2) AVG_DEFENSIVE_SAFETIES,
  ROUND(AVG(DEFENSIVE_TACKLES), 2) AVG_DEFENSIVE_TACKLES,
  ROUND(AVG(DEFENSIVE_SACKS), 2) AVG_DEFENSIVE_SACKS,
  ROUND(AVG(DEFENSIVE_ASSIST_TACKLES), 2) AVG_DEFENSIVE_ASSIST_TACKLES,
  ROUND(AVG(DEFENSIVE_INTERCEPTIONS), 2) AVG_DEFENSIVE_INTERCEPTIONS
FROM
  common_games
...
SELECT
  ...
  AVG_DEFENSIVE_SAFETIES,
  AVG_DEFENSIVE_TACKLES,
  AVG_DEFENSIVE_SACKS,
  AVG_DEFENSIVE_ASSIST_TACKLES,
  AVG_DEFENSIVE_INTERCEPTIONS
FROM
  player_stats ps
...
SELECT
    ...
    player.AVG_DEFENSIVE_SAFETIES AVG_DEFENSIVE_SAFETIES,
    player.AVG_DEFENSIVE_TACKLES AVG_DEFENSIVE_TACKLES,
    player.AVG_DEFENSIVE_SACKS AVG_DEFENSIVE_SACKS,
    player.AVG_DEFENSIVE_ASSIST_TACKLES AVG_DEFENSE_ASSIST_TACKLES,
    player.AVG_DEFENSIVE_INTERCEPTIONS AVG_DEFENSE_INTERCEPTIONS,
    ...
    de.AVG_DEFENSIVE_SAFETIES ALL_AVG_DEFENSIVE_SAFETIES,
    de.AVG_DEFENSIVE_TACKLES ALL_AVG_DEFENSIVE_TACKLES,
    de.AVG_DEFENSIVE_SACKS ALL_AVG_DEFENSIVE_SACKS,
    de.AVG_DEFENSIVE_ASSIST_TACKLES ALL_AVG_DEFENSE_ASSIST_TACKLES,
    de.AVG_DEFENSIVE_INTERCEPTIONS ALL_AVG_DEFENSE_INTERCEPTIONS
FROM
    pa_avgs pa
    JOIN ru_avgs ru ON (pa.SEASON = ru.SEASON)
    JOIN re_avgs re ON (pa.SEASON = re.SEASON)
    JOIN de_avgs de ON (pa.SEASON = de.SEASON)
    ...
    return render_template('player/player_stats.html',
                           ...
                           seasons=seasons, avgs_data=avgs_data, avgs_headers=avgs_headers, num_of_stats=14)
